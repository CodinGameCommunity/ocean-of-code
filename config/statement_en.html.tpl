  ...
  <!-- GOAL -->
    <div class="statement-section statement-goal">
        ...
        <div class="statement-goal-content">
            ...
            You pilot a submarine and you know that an enemy is present near you because you are listening to its radio frequency communication.
        ...
        padding: 2px;">
            ...
            <div class="statement-victory-conditions">
                ...
                <div class="blk">
                    ...
                    <div class="text">Have more lifes than your enemy at the end of the game. Each player has 300 turns including the initial placement.</div>
                </div>
            </div>
            <!-- Lose conditions -->
        ...
        <div class="blk">
            ...
            <div class="text"><span class="statement-lineno">Line 1: </span>a string with 8 space separated integers.
                ...
                <ul>
                    ...
                    <li><var>myLife</var> and <var>oppLife</var> give the number of hit points remaining for, respectively, you and your opponent</li>
                ...
                <span class="statement-lineno">Line 3: </span> <var>opponentOrders</var>, a summary of the actions (separated by <const>|</const>) that your opponent has made during its turn.<br>
                Example: <action>MOVE</action> N |<action>TORPEDO</action> 3 5<br>
                This example indicates that your opponent moved to the north and then fired a torpedo at the cell (3, 5).<br>
                <const>NA</const> is used the first turn of the starting player (this is the only case when your opponent hasn't done anything yet).</div>
        </div>
